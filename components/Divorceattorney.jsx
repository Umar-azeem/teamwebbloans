...
const videos = [
  {
    ...
    videoUrl:
      "https://wowmivh.com/AdrianWebbMortgage/Advisors/AdrianWebb/divorceattorneyproductvideo2.mp4",
  },
  {
    id: 2,
    title: "Refinancing Solutions for Divorcing Couples",
    thumbnail:
      "https://cdn.prod.website-files.com/65d509901b89bb3fd2a62b18/65fb2102ab70346cd36e9deb_divorceattorney3.png",
    videoUrl:
      "https://wowmivh.com/AdrianWebbMortgage/Advisors/AdrianWebb/divorceattorneyproductvideo3.mp4",
  },
  {
    id: 3,
    title: "Protecting Your Client's Interests During the Mortgage Process",
    thumbnail:
      "https://cdn.prod.website-files.com/65d509901b89bb3fd2a62b18/65fb2109ebc5f077de515634_divorceattorney4.png",
    videoUrl:
      "https://wowmivh.com/AdrianWebbMortgage/Advisors/AdrianWebb/divorceattorneyproductvideo4.mp4",
  },
  {
    id: 4,
    title: "Protecting Client Interests in Property Settlements",
    thumbnail:
      "https://cdn.prod.website-files.com/65d509901b89bb3fd2a62b18/65fb210ef244850982115a9b_divorceattorney5.png",
    videoUrl:
      "https://wowmivh.com/AdrianWebbMortgage/Advisors/AdrianWebb/divorceattorneyproductvideo5.mp4",
  },
  {
    id: 5,
    title: "How We Partner To Fit Your Legal Philosophy",
    thumbnail:
      "https://cdn.prod.website-files.com/65d509901b89bb3fd2a62b18/65fb211444e60066a6c0d38a_divorceattorney6.png",
    videoUrl:
      "https://wowmivh.com/AdrianWebbMortgage/Advisors/AdrianWebb/divorceattorneyproductvideo6.mp4",
  },
];
...
const questions = [
  {
    question:
      "How can partnering with a Mortgage Professional benefit my legal practice?",
    answer:
  ...
  {
    question: "What kind of support can I expect from this partnership?",
    answer:
      "Expect a collaborative approach with ongoing communication, strategic mortgage advice tailored to complement your legal strategies, and a commitment to your clients' best interests throughout the divorce process.",
  },
  {
    question: "How will this partnership fit into my current legal strategy?",
    answer:
      "Our partnership is designed to align seamlessly with your legal philosophy, enhancing your strategy with mortgage insights that support your client's goals and financial well-being.",
  },
  {
    question:
      "How can I assure my clients of the benefits of this partnership?",
    answer:
      "When questions of Real Estate and Mortgages arise, our dedicated consultation process provides transparent insight into how our combined expertise protects and benefits them, reassuring clients of the comprehensive support they receive.",
  },
  {
    question: "What's the first step to establishing this partnership?",
    answer:
      "Begin by scheduling a strategic partnership consultation. This initial conversation allows us to understand your legal approach and discuss how we can integrate our services to benefit your clients and practice.",
  },
];

const cards = [
  { Name: "Financial Planner", url: "/Financial-Planner" },
  ...
  return (
    <div className="">
      <Hero
        ...
        title={
          <>
            Helping You Navigate Real
            <br />
            Estate Decisions Through Divorce
          </>
        }
        description="Seamlessly integrate comprehensive real estate and mortgage advice into your divorce cases, ensuring your clients make informed decisions for a brighter future."
        ...
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          <FadeIn className="text-center lg:text-left">
            ...
            <div className="hidden md:flex flex-col md:flex-row items-center gap-2">
              <img
                src="https://cdn.prod.website-files.com/65d509901b89bb3fd2a62af7/65d509901b89bb3fd2a62ca4_image%2067.png"
                alt="Community"
          ...
          >
            <img
              src="https://cdn.prod.website-files.com/65d509901b89bb3fd2a62af7/65d8a906f64c7725e0d9dc0d_photo_2024-02-23_16-05-33.jpg"
              alt="Community"
        ...
        <div className="flex md:flex-row flex-col justify-between gap-10">
          <div className="pl-8">
            ...
            <h1 className="text-[25px] text-center md:text-start sm:text-[40px] lg:text-[36px] leading-[1.2] font-semibold text-[#1f1f1f] mb-4 sm:mb-10">
              Learn more about our customized loan programs for your buyers.
            </h1>
        ...
        <div className="max-w-6xl mx-auto">
          <FadeIn className="text-center mb-12">
            ...
            <h2 className="text-3xl max-w-md sm:text-4xl lg:text-4xl font-bold text-[#1f1f1f] leading-tight mx-auto">
              Guiding Divorce Attorneys: Navigating Clients' Real Estate
...
export default DivorceAttorney;
