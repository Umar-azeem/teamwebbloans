...
function MobileMenu({ open, onClose, onApply, onEducationOpen, onPartnersOpen }) {
  useEffect(() => {
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center justify-between px-5 py-5">
        <button onClick={onClose} aria-label="Close menu" className="text-white hover:text-gray-300 transition">
    ...
    <>
          ...
          <div className="hidden lg:flex items-center gap-3">
            <div className="flex flex-col items-center">
              <img
                ...
                alt="Adrian Webb logo"
              />
              <span className="text-[10px] tracking-wider font-bold text-white">ADRIAN WEBB</span>
            </div>
            <img
          ...
          <div className="hidden lg:flex items-center gap-10 font-bold text-sm text-white">
            ...
            <div className="relative">
              <button
                ...
                onClick={() => { setEducationOpen(!educationOpen); setPartnersOpen(false); }}
              >
                Education
                <svg
            ...
            <div className="relative">
              <button
                className="flex items-center gap-1 hover:text-gray-200 transition"
                onClick={() => { setPartnersOpen(!partnersOpen); setEducationOpen(false); }}
              >
                Partners
                <svg
              ...
              {partnersOpen && <DesktopPartnersDropdown onClose={closeDesktopAll} />}
            </div>
      ...
      {applyOpen && (
        ...
        >
          ...
          >
            <h2 className="text-2xl font-bold text-[#006132] mb-2">Apply Now</h2>
            <p className="text-gray-500 mb-6">Start your mortgage application with Adrian Webb.</p>
            <button
              onClick={() => setApplyOpen(false)}
